...
ALL_STAGES = [
    ...
    ("1.4", "Cache Build (reconciliation, pivot, merge, macro, conflict, estimation)"),
    ("1.5", "Derived Variables + Survival (features, survival mode, hierarchy, FH)"),
    ...
    ("1.8", "Enriched Timeline + Finalization (regime timeline, normalization)"),
