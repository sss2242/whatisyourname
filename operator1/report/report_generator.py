...
TIER_SECTIONS: dict[ReportTier, set[int]] = {
    ...
    ReportTier.PRO: {1, 2, 3, 4, 5, 6, 65, 7, 75, 11, 14, 16, 17, 18, 195, 196, 197, 198, 199, 1995, 1996, 1997, 1998, 1999, 2001, 2002, 20, 2006, 2007, 2008},  # peers + macro + thesis scorecard + position signal + signal IC
