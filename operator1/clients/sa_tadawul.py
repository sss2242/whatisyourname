"""Saudi Arabia Tadawul PIT client.
...
class SATadawulClient:
    ...
    @property
    def market_id(self) -> str: return "sa_tadawul"
    @property
    def market_name(self) -> str: return "Saudi Arabia (Tadawul)"
    ...
    def get_income_statement(self, identifier: str) -> pd.DataFrame:
        ...
        return yf_get_financials(identifier, self.market_id, "income", yf_suffix=".SR")

    def get_balance_sheet(self, identifier: str) -> pd.DataFrame:
        from operator1.clients.yfinance_backed import yf_get_financials
        return yf_get_financials(identifier, self.market_id, "balance", yf_suffix=".SR")

    def get_cashflow_statement(self, identifier: str) -> pd.DataFrame:
        from operator1.clients.yfinance_backed import yf_get_financials
        return yf_get_financials(identifier, self.market_id, "cashflow", yf_suffix=".SR")

    def get_quotes(self, identifier: str) -> pd.DataFrame:
        """Tadawul does not provide OHLCV data. Handled by ohlcv_provider."""
        return pd.DataFrame()
