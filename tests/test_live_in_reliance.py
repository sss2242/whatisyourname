"""Live full-pipeline test: India -- Reliance Industries (RELIANCE).
...
Run: python3.12 -m pytest tests/test_live_in_reliance.py -v
"""
...
class TestINFullPipeline(unittest.TestCase):
    """Full pipeline integration test for India -- Reliance (RELIANCE)."""
    ...
    def test_01_micro_yfinance_profile(self):
        try:
            ...
            self.__class__._profile = {
                "name": info.get("longName", "Reliance Industries"),
                "ticker": TICKER,
                "country": COUNTRY,
